...
import com.payfun.van.daou.fragments.FragmentCallbackInterface.ActivityToHome;
import com.payfun.van.daou.fragments.FragmentCallbackInterface.HomeToActivity;

import static com.payfun.van.daou.fragments.FragmentCallbackInterface.ARG_SECTION_NUM;
import static com.payfun.van.daou.fragments.FragmentCallbackInterface.ActivityToHomeCmd_DeviceAdapter;

/**
 * Created by david_shkim on 2018-03-13.
 */

public class FragmentDummy extends Fragment implements ActivityToHome{

    public static FragmentDummy newInstance(int sectionNumber) {
        FragmentDummy fragment = new FragmentDummy();
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallback = (HomeToActivity) mActivity;
...
*/ // ToDo:: End of onCreate
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       //  allocate the dummy fragment onto container
        mFragmentView = inflater.inflate(R.layout.fragment_dummy, container, false);
...
*/    //  ToDo:: End of onSaveInstanceState
     ...
     *  #1. declare callback
     */
    private HomeToActivity mCallback;
